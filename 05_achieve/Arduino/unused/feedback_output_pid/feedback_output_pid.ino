...
// ✅ 바퀴 정보 및 거리 계산 상수
const float wheelRadiusM = 0.04;  // 4cm
const float wheelCircumferenceM = 2 * PI * wheelRadiusM;  // 약 0.2513m
const float countsPerRevolution = 268.0;  // 1바퀴당 엔코더 카운트

// ✅ 거리 계산 함수 (단위: m)
float getCartDistanceM() {
  return (encoderCount * wheelCircumferenceM) / countsPerRevolution;
}
